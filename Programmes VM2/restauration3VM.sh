...
SRC1="vboxuser@192.168.56.102:/home/vboxuser/sauvegardes2/"
SRC2="vboxuser@192.168.56.101:/home/vboxuser/sauvegardes2/"
SRC3="vboxuser@192.168.56.103:/home/vboxuser/sauvegarde_complet2/"
...
if $SUCCESS1 && $SUCCESS2; then
    ...
    echo "✅ Restauration fusionnée réussie depuis VM2 et VM1."
else
