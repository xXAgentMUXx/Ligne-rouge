...
def restauration():
    vm = var_vm.get()
    if vm == "VM2":
        cmd = ["pkexec", "rsync", "-av", "vboxuser@192.168.56.102:/home/vboxuser/sauvegardes/", "/home/vboxuser/Documents/"]
    elif vm == "VM3":
        cmd = ["pkexec", "rsync", "-av", "vboxuser@192.168.56.103:/home/vboxuser/sauvegardes/", "/home/vboxuser/Documents/"]
    else:
