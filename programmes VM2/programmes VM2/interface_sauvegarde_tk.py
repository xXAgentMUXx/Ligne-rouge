...
def sauvegarde():
    try:
        ...
        messagebox.showinfo("Succès", "Sauvegarde effectuée avec succès sur VM1 et VM3.")
...
def restauration():
    vm = var_vm.get()
    if vm == "VM1":
        cmd = ["pkexec", "rsync", "-av", "vboxuser@192.168.56.101:/home/vboxuser/sauvegardes/", "/home/vboxuser/Documents/"]
    elif vm == "VM3":
        cmd = ["pkexec", "rsync", "-av", "vboxuser@192.168.56.103:/home/vboxuser/sauvegardes2/", "/home/vboxuser/Documents/"]
    else:
