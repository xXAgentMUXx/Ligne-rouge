...
def sauvegarde():
    try:
        subprocess.run(["pkexec", "rsync", "-av", "/home/vboxuser/Documents/", "/home/backupuser/backup/"], check=True)
...
def restauration():
    try:
        subprocess.run(["pkexec", "rsync", "-av", "/home/backupuser/backup/", "/home/vboxuser/Documents/"], check=True)
